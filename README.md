...
програми. (https://github.com/goitacademy/react-homework-template#readme)</li>
...
вихідним кодом проекту. </li>
<li>У шапці репозиторія є посилання на живу сторінку на `GitHub pages`. </li>
